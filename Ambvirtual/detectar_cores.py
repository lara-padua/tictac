...
color_ranges = {
    ...
    "Vermelho1":((0, 120, 70),  (10, 255, 255), (0, 0, 255)),
    "Vermelho2":((170, 120, 70),(180, 255, 255), (0, 0, 255)),
...
# Kernel fixo (não recriar a cada loop)
...
while True:
    ...
    if cor_fixa is None:
        ...
        if time.time() - tempo_inicio >= tempo_espera:
            print(f"Tempo expirado para a cor {cor_fixa}. Pronto para nova detecção.")
            cor_fixa = None
            tempo_inicio = None
        else:
